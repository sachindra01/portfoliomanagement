          ...
          ? SizedBox(
            ...
            GridView.builder(
              ...
              itemBuilder: (BuildContext ctx, index) {
                var x=  (int.parse(stockManageController.stockList[index].transactionQuantity)*int.parse(stockManageController.stockList[index].sellingPrice))-int.parse(stockManageController.stockList[index].sellingPrice);
                if( int.parse(stockManageController.stockList[index].sellingPrice)>(int.parse(stockManageController.stockList[index].transactionQuantity)*int.parse(stockManageController.stockList[index].sellingPrice))){
                  y='loss';
                      ...
                      child: Column(children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(stockManageController.stockList[index].sellingPrice,style: const TextStyle(
                              color: Colors.white,fontSize: 15.0
                              )),
                            ],
                          ),
